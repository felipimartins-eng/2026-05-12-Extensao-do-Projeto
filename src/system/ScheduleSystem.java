...
public class ScheduleSystem implements IScheduleSystem {
    ...
    public boolean makeSchedule(User user, Integer roomId, String date, int time) {
        ...
        if (success)
            out.print("Agendamento Realizado Com Sucesso!");
        else
            out.print("Agendamento Fracassou: Sala Ocupada.");
    ...
    public boolean cancelSchedule(User user, Integer roomId, String date, int time) {
        ...
        if (success)
            out.print("Cancelamento Realizado Com Sucesso!");
        else
            out.print("Cancelamento Fracassou: Usuario Nao Possui a Sala");
    ...
    public HashMap<Integer, BaseRoom> getRooms(String begin, String end, boolean fullOnly) {
        ...
        for (BaseRoom room : roomHash.values()) {
            ...
            if ((!fullOnly && isFull) || (fullOnly && !isFull))
                continue;
